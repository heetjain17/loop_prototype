  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn("select-none font-medium text-base", captionLayout === "label"
          ? "text-base"
          : "rounded-md pl-2 pr-1 flex items-center gap-1 text-base h-8 [&>svg]:text-muted-foreground [&>svg]:size-4", defaultClassNames.caption_label),
